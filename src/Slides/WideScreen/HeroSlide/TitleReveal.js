/**
 * TitleReveal Component - Animated text reveal with GSAP
 * 
...
/**
 * TitleReveal Component - Text reveal animation using GSAP
 * 
 ...
 */
const TitleReveal = ({ text, fontFamily, timeDelay }) => {
  ...
  const [reveal, setReveal] = useState(false); // Track reveal state
...
TitleReveal.defaultProps = {
  fontFamily: 'Avenir Helvetica Ariel',
};
